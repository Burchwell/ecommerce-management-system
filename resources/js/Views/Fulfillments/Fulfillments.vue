                        ...
                        <b-row>
                            <b-col>
                                ...
                                <div class="widget-11-3-table tableFixHead p-3">
                                    <b-table class="table-sm table-striped" hover
                                    ...
                                    >
                                        ...
                                        <template slot="thead-top" slot-scope="data">
                                            <b-tr class="d-none d-md-table-row">
                                                <b-th colspan="2" class="bg-secondary text-white text-center">&nbsp;
                                                </b-th>
                                                <b-th colspan="3" class="bg-danger text-white text-center">
                                                    Profitability
                                                </b-th>
                                                <b-th class="bg-success text-white text-center">Profit</b-th>
                                                <b-th colspan="2" class="bg-info text-white text-center">Quantity On
                                                    Hand
                                                </b-th>
                                                <b-th colspan="4" class="bg-primary text-white text-center">FBA
                                                    Inventory
                                                </b-th>
                                                <b-th colspan="4" class="bg-blue-lighter text-white text-center">Turn
                                                    <small>(30 Days)</small>
                                                </b-th>
                                            </b-tr>
                                        </template>
...
export default {
    ...
    watch: {
        search: function (val) {
            this.pagination = Object.assign(this.pagination, {
                ...
                sortBy: this.pagination.sortBy || "turn_around_time_fba",
                sortDesc: this.pagination.sortDesc || true
            });
    ...
    data() {
        return {
            ...
            table: {
                columns: [
                    {key: 'id', label: "", class: 'd-none d-md-table-cell bg-gray-50', sortable: true},
                    ...
                    {
                        key: 'quantity_on_hand_las_vegas',
                        label: "Las Vegas",
                        class: "text-center d-none d-md-table-cell",
                        sortable: true,
                        visible: true,
                    ...
                    {
                        key: 'fba_reserved_fc_processing',
                        label: "Processing",
                        class: "text-center d-none d-md-table-cell",
                        sortable: true,
                        formatter(value, key, item) {
                    ...
                    {
                        key: 'fba_reserved_customer_orders',
                        label: "Pending",
                        class: "text-center d-none d-md-table-cell",
                        sortable: true,
                        visible: true,
                    ...
                    {
                        key: 'turn_around_time_las_vegas',
                        label: "Las Vegas",
                        class: "text-center d-none d-md-table-cell",
                        sortable: true,
                        visible: true,
    ...
    methods: {
        ...
        async fetchData() {
            try {
                ...
                const response = await api.get(`/products/fulfillments${filters.length > 0 ? '?' + filters : ''}`);
